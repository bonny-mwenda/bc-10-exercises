...
class CarClassTest(unittest.TestCase):
    ...
    def test_car_instance(self):
        ...
        self.assertIsInstance(
            honda, Car, msg='The object should be an instance of the `Car` class')
    ...
    def test_default_car_model(self):
        gm = Car()
        self.assertEqual(
            'GM', gm.model, msg="The car's model should be called `GM` if no model was passed as an argument")
